...
class Ui_VentasA(object):
    def setupUi(self, VentasA):
        VentasA.setObjectName("VentasA")
        VentasA.resize(1390, 1072)
        VentasA.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"")
        self.horizontalLayout = QtWidgets.QHBoxLayout(VentasA)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.Contenedor = QtWidgets.QWidget(VentasA)
...
"")
        ...
        self.retranslateUi(VentasA)
        QtCore.QMetaObject.connectSlotsByName(VentasA)

    def retranslateUi(self, VentasA):
        _translate = QtCore.QCoreApplication.translate
        VentasA.setWindowTitle(_translate("VentasA", "Form"))
        self.label_3.setText(_translate("VentasA", "Código"))
        self.label.setText(_translate("VentasA", "Precio Unitario"))
        self.label_6.setText(_translate("VentasA", "Marca"))
        self.label_5.setText(_translate("VentasA", "Nombre"))
        self.label_7.setText(_translate("VentasA", "Cantidad"))
        self.label_8.setText(_translate("VentasA", "Valor Domicilio"))
        self.LabelVentasA.setText(_translate("VentasA", "Ventas"))
        self.label_30.setText(_translate("VentasA", "Productos"))
        self.BtnEliminar.setText(_translate("VentasA", "   Eliminar"))
        self.BtnFacturaA.setText(_translate("VentasA", "Detal"))
        self.BtnFacturaB.setText(_translate("VentasA", "Reventa"))
        self.BtnFacturaC.setText(_translate("VentasA", "Al por Mayor"))
        item = self.tableWidget.verticalHeaderItem(0)
        item.setText(_translate("VentasA", "Nueva fila"))
        ...
        item.setText(_translate("VentasA", "New Row"))
        item = self.tableWidget.verticalHeaderItem(15)
        item.setText(_translate("VentasA", "New Row"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("VentasA", "Código"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("VentasA", "Producto"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("VentasA", "Marca"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("VentasA", "Categoria"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("VentasA", "Cantidad"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("VentasA", "Precio"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("VentasA", "Total"))
        self.label_10.setText(_translate("VentasA", "Nombre y apellido:"))
        self.LabelSubtotal.setText(_translate("VentasA", "$"))
        self.label_9.setText(_translate("VentasA", "Teléfono:"))
        self.label_12.setText(_translate("VentasA", "Metodo de Pago"))
        self.BtnGenerarVenta.setText(_translate("VentasA", "Generar Venta"))
        self.label_14.setText(_translate("VentasA", "Subtotal"))
        self.label_31.setText(_translate("VentasA", "Cliente"))
        self.label_4.setText(_translate("VentasA", "Cedula de Ciudadania:"))
        self.label_11.setText(_translate("VentasA", "Dirección:"))
        self.label_13.setText(_translate("VentasA", "Pago"))
        self.LabelTotal.setText(_translate("VentasA", "$"))
        self.label_15.setText(_translate("VentasA", "Total"))
