...
"")
        ...
        self.BtnCambio = QtWidgets.QToolButton(self.QWNavbar)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.BtnCambio.setIcon(icon2)
        self.BtnCambio.setIconSize(QtCore.QSize(30, 30))
        self.BtnCambio.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.BtnCambio.setObjectName("BtnCambio")
        self.verticalLayout.addWidget(self.BtnCambio)
...
"")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("assets/iconos/Facturas.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.BtnFacturas.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("assets/iconos/Reportes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("assets/iconos/Clientes.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"font-size: 14px;")
    ...
    def retranslateUi(self, Navbar):
        ...
        self.BtnCambio.setText(_translate("Navbar", "   Devolucion"))
