...
"")
        ...
        self.InputPrecioEspecial = QtWidgets.QLineEdit(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.InputPrecioEspecial.sizePolicy().hasHeightForWidth())
        self.InputPrecioEspecial.setSizePolicy(sizePolicy)
        self.InputPrecioEspecial.setMaximumSize(QtCore.QSize(250, 50))
        self.InputPrecioEspecial.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.InputPrecioEspecial.setObjectName("InputPrecioEspecial")
        self.gridLayout_2.addWidget(self.InputPrecioEspecial, 8, 0, 1, 1)
...
"")
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.TablaProductos.setHorizontalHeaderItem(13, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.TablaProductos.setHorizontalHeaderItem(14, item)
    ...
    def retranslateUi(self, Productos):
        ...
        self.label_13.setText(_translate("Productos", "Precio Especial"))
        ...
        item.setText(_translate("Productos", "Estado"))
        item = self.TablaProductos.horizontalHeaderItem(13)
        item.setText(_translate("Productos", "PE"))
        item = self.TablaProductos.horizontalHeaderItem(14)
        item.setText(_translate("Productos", "GE"))
