...
"")
        ...
        self.InputPrecioReventa = QtWidgets.QLineEdit(self.widget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.InputPrecioReventa.sizePolicy().hasHeightForWidth())
        self.InputPrecioReventa.setSizePolicy(sizePolicy)
        self.InputPrecioReventa.setMaximumSize(QtCore.QSize(250, 50))
        self.InputPrecioReventa.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.InputPrecioReventa.setObjectName("InputPrecioReventa")
        self.gridLayout_2.addWidget(self.InputPrecioReventa, 8, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, Productos):
        ...
        self.label_13.setText(_translate("Productos", "Precio Reventa"))
